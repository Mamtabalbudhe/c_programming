...
{
    //clrscr();
    printf("hello my name is mamta");
    getch();
   // 1. Explain the Significance of while(), do..whike(); for() ..By Giving suitable examples . Expecting which loop will be best at what circumstances.
